...
func (x *CancelResponse) GetCancelledCount() int64 {
	if x != nil {
...
func (x *CancelResponse) GetSkippedCount() int64 {
	if x != nil {
		return x.SkippedCount
	}
	return 0
